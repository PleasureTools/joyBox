...
describe('BoolFilter', () => {
    describe('Test', () => {
        ...
        describe('Some case: query=!a&!b|(c|!d)&e', () => {
            const f = new BoolFilter('!a&!b|(c|!d)&e');
            it('c -> true', () => chai.expect(f.Test('c')).to.equal(true));
        ...
        describe('Some case: query=a&(b^(c|e)&d)', () => {
            const f = new BoolFilter('a&(b^(c|e)&d)');
        ...
        describe('Invalid syntax: query=a||b', () => {
            it('ValidationError', () => chai.expect(() => new BoolFilter('a||b')).to.throw('Unexpected token'));
        });
    });
});
