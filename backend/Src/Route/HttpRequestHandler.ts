...
export class HttpRequestHandler {
    ...
    public constructor(private app: AppFacade, private express: Application) {
        ...
        if (C.DefaultAccess === AppAccessType.NO_ACCESS) {
            ...
            this.express.post(UPLOAD_VIDEO_PATH, authGuard.Middleware, uploadMiddleware, this.UplaodVideoRoute.bind(this));
        } else {
            this.express.post(UPLOAD_VIDEO_PATH, uploadMiddleware, this.UplaodVideoRoute.bind(this));
        }
    ...
    public async UplaodVideoRoute(request: Request, response: Response, next: NextFunction) {
